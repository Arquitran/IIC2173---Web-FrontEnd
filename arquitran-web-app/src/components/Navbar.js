      ...
      return (
        <nav className="navbar navbar-toggleable-md navbar-light bg-faded navbot">
          ...
          <div className="collapse navbar-collapse">
            ...
            <button className="btn btn-outline-danger" type="submit" onClick={this.props.logOut}>Log Out</button>
          </div>
        </nav>
      );
    }
    return(
      <nav className="navbar navbar-toggleable-md navbar-light bg-faded navbot">
        ...
        <div className="collapse navbar-collapse">
          ...
          <button className="btn btn-outline-primary" type="submit"><NavLink to="/signin">Sign In</NavLink></button>
        </div>
      </nav>
    );
